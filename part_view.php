    ...
    <div class="row btn-down">
        <?php if (!empty($user["id"]) && !my_part($part["pid"], $user["id"])) { ?>
            <div class="col-sm-6 col-xs-6">
                <a href="//<?= URL; ?>/part/<?= $part["pid"]; ?>" class="btn btn-primary btn-flat btn-product"><span class="icon icon-read-more"></span> <span class="hidden-xs">Podrobnosti</span></a>
            </div>
            <div class="col-sm-6 col-xs-6">
        ...
        <?php } else { ?>
            ...
            <div class="col-sm-6 col-xs-6">
                <a href="//<?= URL; ?>/editPart/<?= $part["pid"]; ?>" class="btn btn-primary btn-flat btn-product"><span class="icon icon-pencil"></span> <span class="hidden-xs">Uredi</span></a>
            </div>
        <?php } ?>
    </div>
</div>