<html>
    <head>    <link href='http://fonts.googleapis.com/css?family=Open+Sans&amp;subset=latin,latin-ext' rel='stylesheet' type='text/css'><meta http-equiv="Content-Type" content="text/html; charset=utf-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Minty-Multipurpose Responsive Email Template</title><style type="text/css">
            ...
            <table bgcolor="#f6f4f5" width="100%" cellpadding="0" cellspacing="0" border="0">
                <tbody>
                    <tr>
                        <td width="100%">
                            <div class="innerbg">
                            ...
                            <table width="580" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth">
                                <tbody>
                                    ...
                                    <tr>
                                        <td align="right" valign="middle" style="font-family: 'Open sans', arial, sans-serif; font-size: 10px;color: #999999">
                                            <p>
                                                Poglej to sporočlo v brskalniku
                                            </p>
                                        </td>
                                    </tr>
                                    <!-- Spacing -->
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
                                                            <div class="imgpop">
                                                                <span class="color-info">AVTO</span>DELI
                                                            </div>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td style="font-family: 'Open sans', arial, sans-serif; font-size: 14px; color: #95a5a6; text-align:center;line-height: 30px;">
                                                            <p>
                                                                Prosimo kliknite na gumb spodaj za aktivacijo računa.
                                                            </p>
                                                        </td>
                                                    </tr>
                                                    <!-- End of content -->
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td style="padding-left:18px; padding-right:18px;font-family:'Open sans', arial, sans-serif; text-align:center;  color:#ffffff; font-weight: 300; border-radius: 0px;" width="auto" align="center" valign="middle" height="36">
                                                                            <span style="color: #ffffff; font-weight: 300;"> <a style="color: #ffffff; text-align:center;text-decoration: none;" href="#" tabindex="-1">AKTIVIRAJ</a></span>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
