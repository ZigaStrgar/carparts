...
<div class="block-flat col-lg-12 top-primary">
    <h1 class="page-header">Pogoji poslovanja in uporabe</h1>
    <h3 class="page-header" id="general">Splošni pogoji</h3>
    <p>
    ...
    <h3 class="page-header" id="change">Spreminjanje pogojev</h3>
    <p>
    ...
    <h3 class="page-header" id="user">Uporabnik</h3>
    <p>
    ...
    <p>
        Oglaševanje uporabnikov je določeno s posebnimi pravili, podjetje ne odgovarja za vsebino posameznih oglasov ali vsebin.
    </p>
    <h3 class="page-header" id="control">Nadzor vsebine in uporabnikov</h3>
    <p>
    ...
    <h3 class="page-header" id="privacy">Zasebnost</h3>
    <p>
        Vsi osebni podatki, ki jih uporabnik vpiše ne bodo nikoli posredovani tretjim osebam in bodo izklučno uporabljene za poslovne namene (pošiljanje paketov in komunikacijo).
    </p>
</div>
