    ...
    <form action="editingprofile.php" method="POST" class="ajaxForm">
        ...
        <div class="row">
            <div class="col-lg-4 col-xs-12">
                <div class="input-group<?php if(empty($user["name"])) { echo " has-error"; } ?>">
            ...
            <div class="col-lg-4 col-xs-12">
                <div class="input-group<?php if(empty($user["surname"])) { echo " has-error"; } ?>">
                    <span class="input-group-addon"><i class="icon icon-contact-2"></i></span>
                    <input type="text" name="surname" class="form-control" value="<?php echo $user["surname"]; ?>" placeholder="Vnesite priimek" />
                </div>
            </div>
            <div class="col-lg-4 col-xs-12<?php if(empty($user["email"])) { echo " has-error"; } ?>">
        ...
        <div class="row">
            <div class="col-lg-4 col-xs-12">
                <div class="input-group<?php if(empty($user["phone"])) { echo " has-error"; } ?>">
            ...
            <div class="col-lg-4 col-xs-12">
                <div class="input-group<?php if(empty($user["location"])) { echo " has-error"; } ?>">
            ...
            <div class="col-lg-4 col-xs-12">
                <div class="input-group<?php if(empty($user["city_id"])) { echo " has-error"; } ?>">
