...
?>
            ...
            <div class="col-lg-8">
                ...
                <?php if ( ! empty($user["id"]) ) { ?>
                    ...
                    <?php if ( my_part($id, $_SESSION["user_id"]) ) { ?>
                        ...
                        <a href="../editPart/<?php echo $id; ?>" class="btn btn-flat btn-primary"><i class="icon icon-pencil"></i>
                            Uredi del</a>
    ...
    <div style="display: none;" itemscope itemtype="http://schema.org/Product">
        <span itemprop="name"><?= $part["partname"] ?></span>
        <img itemprop="image" src="<?= $part["image"] ?>" alt="Executive Anvil logo"/>
        <span itemprop="description"><?= strip_tags($part["description"]); ?></span>
        Številka izdelka: <span itemprop="mpn"><?= $part["pid"] ?></span>

  <span itemprop="offers" itemscope itemtype="http://schema.org/Offer">
    <meta itemprop="priceCurrency" content="EUR"/>
    <span itemprop="price"><?= $part["price"]; ?></span> €
